...
var leftBoxSprite, leftBoxBody,
	bottomBoxSprite, bottomBoxBody,
	rightBoxSprite, rightBoxBody;
...
function setup() {
	...
	leftBoxSprite = createSprite(290, 610, 20, 100);
	leftBoxSprite.shapeColor = color("red");

	rightBoxSprite = createSprite(510, 610, 20, 100);
	...
	leftBoxBody = Bodies.rectangle(290, 610, 20, 100, {isStatic:true});
	World.add(world, leftBoxBody);

	rightBoxBody = Bodies.rectangle(510, 610, 20, 100, {isStatic:true});
